...
<%@ include file="/views/common/commonLink.jsp" %>
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/booking/booking.css" />
    <link rel="stylesheet" href="<%=request.getContextPath() %>/css/booking/bookingPopup.css" />
   ...
   <%@ include file="/views/common/bookingHeader.jsp" %> 
        <section class="section">
                <div class="reservation">
                    ...
                    <form class="personnel">인원: 
                        <label class="personnel1" for="card">성인</label>
                        <input class="personnel1" type="number" name="nval" min="0" max="10" step="1" value="0"  >
                        <label class="personnel1" for="card">소아</label>
                        <input class="personnel1" type="number" name="nval" min="0" max="10" step="1" value="0">
                        <label class="personnel1" for="card">유아</label>
                        <input class="personnel1" type="number" name="nval" min="0" max="10" step="1" value="0">
                    </form> <br><br>
                    <form class="cuphone">쿠폰사용 : 보유쿠폰수량  ?개
                       
                        개<input  class="personnel1" type="submit" value="사용하기">
                    </form> <br>
                    ...
                    <div class="guidanceBox">
                        <div class="guidanceLine">
                            한 번 더 확인해주세요! <br>
                            써니 사이드업은 많은 여행자가 다녀가는 공간이기에 몇 가지 이용 수칙이 있습니다. <br>당일 예약, 입실은 불가능합니다. <br>체크인 시간은 15:00 이후, 체크아웃 시간은 11:00 이전입니다.<br> 써니사이드업의 전 객실은 기본 2인을 기준으로 합니다.<br> (1인 만원 추가, 최대 4인) 써니사이드업 스테이는 안전상의 이유로 노키즈존입니다. <br>13~19세의 미성년자는 보호자 동반 시에만 숙박이 가능합니다 . <br>사전 예약된 숙박인원 외 방문자 입실은 불가하며 이에 따른 책임은 게스트에게 있습니다. <br>(위반시 퇴실조치 되오니 유의해주세요.) 반려동물 동반 입실은 불가합니다. <br>건물 앞 흡연과 실내 흡연은 엄격히 금지됩니다. <br>(담배꽁초 민원이 들어옵니다. 실내흡연시엔 50만원의 청소비를 부담하게 됩니다. 전자담배포함) 실내에서 냄새나 연기가 많이 나는 구이류(생선, 고기) 요리를 하실 수 없습니다. <br>여러 가구가 살고 있는 조용한 마을이기에 늦은밤 큰 소리는 삼가주세요. <br>2박 숙박시, 수건 교체와 청소는 제공되지 않고 3박 이상 숙박시 침구 및 수건 교체와 청소가 제공됩니다. <br>안전을 위한 CCTV가 2층 현관 앞에 설치되어 있습니다. 해변 이용 시 1층 카페 옆 수고에서 모래와 바닷물을 충분히 제거하시고 입장하세요. <br>(모래로 인해 샤워 시 배수구가 막히게 됩니다.) 사전에 협의되지 않은 상업 사진, 영상 촬영 (광고, 제품사진, 쇼핑몰, SNS 마켓)은 불가합니다. <br>시설, 집기의 훼손 또는 파손시 경우에 따라 변상비를 청구할 수 있습니다. <br>(오염이나 훼손, 파손 시 매니저에게 필히 알려주세요.) 헤어 염색으로 인한 타월 오염이 예상될 경우 미리 말씀해주세요. (짙은색 타월로 교체해드립니다.) <br>모든 제품은 써니 사이드업 내에서만 사용 가능하며 외부로 가져가실 수 없습니다. <br>계단이 미끄럽습니다. 비오는 날 각별히 주의하세요. (날씨가 좋지 않은 날에는 옥상 출입이 금지됩니다.) <br>실내에서 성냥, 라이터, 초 등 화기 사용은 제한됩니다. <br><br>위의 사항은 엄격히 관리하고 있습니다. 위반 시, 강제퇴실과 위약금이 발생하니 소중하게 사용해주세요.
                        </div>
                    </div>
                    <div class="refund">
                        환불규정 <br> 환불 시 아래의 기준일에 따른 환불 금액을 드립니다. <br>이용 10일전까지 총 결제금액의 100% 환불 <br>이용 9일전까지 총 결제금액의 90% 환불 <br>이용 8일전까지 총 결제금액의 80% 환불 <br>이용 7일전까지 총 결제금액의 70% 환불 <br>이용 6일전까지 총 결제금액의 60% 환불 <br>이용 5일전까지 총 결제금액의 50% 환불 <br>이용 4일전까지 총 결제금액의 40% 환불 <br>이용 3일전부터 변경 / 환불 불가
                    </div>
                </div>

                <div class="guestRoom">
                    <div class="guestInfo">객실정보
                        <div class="guestInfo2">
                            <div>써니 사이드업</div> <br>
                            <div>써니 사이드업은 당신만을 위한 휴식의 공간입니다.</div> <br>

...
<body>
		...
		<div class="banner">
			<form class="searchBox" style="display:flex;">
				...
				<div style="display:flex; flex-direction:column;">
					<input type="button" name="checkInBtn" id="checkInBtn" value="체크인">
					<input type="text" name="checkIn" id="checkIn" value="날짜선택" readonly>
				</div>
				<div style="display:flex; flex-direction:column;">
					<input type="button" name="checkOutBtn" id="checkOutBtn" value="체크아웃"> 
	...
	<script>
    	function fn_search(){
    		$(".searchBox").attr("action", "<%=request.getContextPath()%>
		/house/houseSearchList")
					.submit();
		}
	</script>
</body>
